...
public interface IGenericRepository<TEntity> where TEntity : BaseEntity
{
    ...
    Task<List<TEntity>> GetPagedAsync(PaginationParameters paginationParameters, Expression<Func<TEntity, bool>> predicate, bool disableTracking = true, CancellationToken cancellationToken = default);
